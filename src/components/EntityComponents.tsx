...
import { AlertTriangleIcon, Icon, Loader2Icon, MoreVerticalIcon, PackageOpenIcon, PlusIcon, SearchIcon, Trash2Icon } from 'lucide-react';
...
interface EntityItemComponentProps {
    href: string;
    title: string;
                                        ...
                                        <DropdownMenu>
                                            <DropdownMenuTrigger asChild>
                                                <Button
                                                    size={"icon"}
                                                    variant={"ghost"}
                                                    //Reason for stop propagation is when you clik on the drop down menu it does not take you away.
